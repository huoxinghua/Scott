...
[System.Serializable]
public class ToonFeatureSetting
{
    public LayerMask excludeLayer = 0;
}
public sealed class ToonScriptRendererFeature : ScriptableRendererFeature
{
    [SerializeField]
    private ToonFeatureSetting setting = new ToonFeatureSetting();
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        var camLayerMask = renderingData.cameraData.camera.cullingMask;
        if((setting.excludeLayer.value & camLayerMask) == 0)
        {
            return;
        }
        ...
        ToonScriptVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<ToonScriptVolumeComponent>();
